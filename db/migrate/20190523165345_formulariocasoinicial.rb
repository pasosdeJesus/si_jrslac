class Formulariocasoinicial < ActiveRecord::Migration[6.0]
  def up
    execute <<-SQL
      ...
      INSERT INTO pestanafc(id, formulariocaso_id, titulo, parcial) VALUES 
       (1, 1, 'Datos Básicos', 'basicos');
      INSERT INTO pestanafc(id, formulariocaso_id, titulo, parcial) VALUES 
       (2, 1, 'Contacto', 'contacto');
      INSERT INTO pestanafc(id, formulariocaso_id, titulo, parcial) VALUES 
       (3, 1, 'Núcleo Familiar', 'victimas');
      INSERT INTO pestanafc(id, formulariocaso_id, titulo, parcial) VALUES 
       (4, 1, 'Refugio', 'refugio');
      INSERT INTO pestanafc(id, formulariocaso_id, titulo, parcial) VALUES 
       (5, 1, 'Anexos', 'sivel2_gen/casos/anexos');
      INSERT INTO pestanafc(id, formulariocaso_id, titulo, parcial) VALUES 
       (6, 1, 'Etiquetas', 'sivel2_gen/casos/etiquetas');
    SQL
  end
  def down
  end
